...
export default async function Salon() {
    ...
    return <div className={styles.site}>
        ...
        <main className={styles.main}>
            <section className={styles.hero}><div className={styles.heroCopy}><p className={styles.eyebrow}>BELLEZA · CUIDADO · TU MOMENTO</p><h1>{settings.headline}</h1><p className={styles.intro}>{settings.introduction}</p><div className={styles.actions}><Link className={styles.button} href="/reservar">Quiero reservar <span>↗</span></Link><a className={styles.textLink} href="#servicios">Explorar servicios ↓</a></div><p className={styles.heroNote}>Elige tu servicio y una hora disponible.<br/>Confirmaremos tu cita por WhatsApp.</p></div><div className={styles.art} aria-hidden="true"><Image src={heroLogo} alt="" className={styles.heroLogo} sizes="(max-width: 680px) 260px, (max-width: 1100px) 40vw, 460px" priority/></div></section>
