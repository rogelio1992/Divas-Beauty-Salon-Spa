...
export default function Home() {
  ...
  async function createAppointment(event: FormEvent<HTMLFormElement>) {
    ...
    const { error } = await supabase.from("appointments").insert({ client_name: form.get("client"), service_id: service.id, starts_at: startsAt, duration_minutes: service.duration_minutes, status: "pending" });
