...
export default function Home() {
  ...
  async function createAppointment(event: FormEvent<HTMLFormElement>) {
    ...
    if (availabilityError || conflict) { setNotice(conflict ? "Ese horario ya está ocupado para esta profesional." : "No se pudo comprobar la disponibilidad."); return; }
